...
|<img align="center" width="600" src="figures/bn_with_lattice.png">| *Overlay of the hexagonal boron nitride crystal structure on a microscope image of a 2D boron nitride crystal. The crystal tends to cleave along high-symmetry directions of the crystal lattice, which occur every 30 degrees.*|
|----------|:-------------:|------:|
