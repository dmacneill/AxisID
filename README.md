...
*Left: Boron nitride crystal with some edges indicated. Right: histogram of the orientation of indicated edges (moduluo 30). The color of the bars correspond to the color of the edges in the left panel. The high symmetry lattice directions are oriented around 16 degrees.*
