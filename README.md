...
*Left: Boron nitride crystal with some edges indicated. Right: histogram of the orientation of indicated edges (moduluo 30). The color of the bars corresponds to the color of the edges in the left panel. The crystal axis is oriented at about 16 degrees.*
